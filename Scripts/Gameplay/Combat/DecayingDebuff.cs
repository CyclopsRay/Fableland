...
/// <summary>
/// A stackable, self-decaying "points" status shared by hazard-driven statuses
...
/// hit adds flat points on top of whatever is left (capped at <see cref="MaxStack"/>),
/// so repeated exposure stacks.
/// </summary>
public class DecayingDebuff
{
    private const float TickInterval = 0.2f;
    private const float DecayFraction = 0.1f;
    public const float MaxStack = 99f;
